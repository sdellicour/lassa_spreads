...
for (i in 1:length(datasets))
	{
		...
		pseudo_absences = xyFromCell(backgrounds[[i]], sample(which(!is.na(values(backgrounds[[i]]))), 1000, prob=probas, replace=F))
		...
		for (m in 1:length(models))
			{
				...
				envVariables[[2]][] = envVariables[[2]][]*60*60*24 # conversion to kg/m2/day
				for (i in c(1,2,9)) envVariables[[i]][is.na(envVariables[[3]][])] = NA
				c = c+1; rasters_stacks[[c]] = stack(envVariables)
			}
	}
...
for (i in 1:length(analyses))
	{
		...
		plot(africa3, add=T, border="gray50", lwd=0.5)
		mtext("", side=3, line=0.3, cex=0.65, col="gray30"); mtext(paste0("Scenario RCP 2.6"), side=3, line=-0.7, cex=0.65, col="gray30")
		plot(legend1, col=rev(colorRampPalette(brewer.pal(11,"RdYlBu"))(131))[21:131], legend.only=T, add=T, legend.width=0.5, legend.shrink=0.3, smallplot=c(0.10,0.80,0.03,0.06), adj=3, axis.args=list(cex.axis=0.7, lwd=0, lwd.tick=0.2, col.tick="gray30", tck=-0.6, col="gray30", col.axis="gray30", line=0, mgp=c(0,0.1,0), at=seq(0,1,0.25), labels=c("0","0.25","0.5","0.75","1")), alpha=1, side=3, horizontal=T)
		...
		plot(africa3, add=T, border="gray50", lwd=0.5)
		mtext("", side=3, line=0.3, cex=0.65, col="gray30"); mtext("Scenario RCP 6.0", side=3, line=-0.7, cex=0.65, col="gray30")
		plot(legend1, col=rev(colorRampPalette(brewer.pal(11,"RdYlBu"))(131))[21:131], legend.only=T, add=T, legend.width=0.5, legend.shrink=0.3, smallplot=c(0.10,0.80,0.03,0.06), adj=3, axis.args=list(cex.axis=0.7, lwd=0, lwd.tick=0.2, col.tick="gray30", tck=-0.6, col="gray30", col.axis="gray30", line=0, mgp=c(0,0.1,0), at=seq(0,1,0.25), labels=c("0","0.25","0.5","0.75","1")), alpha=1, side=3, horizontal=T)
		...
		plot(africa3, add=T, border="gray50", lwd=0.5)
		mtext("", side=3, line=0.3, cex=0.65, col="gray30"); mtext("Scenario RCP 8.5", side=3, line=-0.7, cex=0.65, col="gray30")
		plot(legend1, col=rev(colorRampPalette(brewer.pal(11,"RdYlBu"))(131))[21:131], legend.only=T, add=T, legend.width=0.5, legend.shrink=0.3, smallplot=c(0.10,0.80,0.03,0.06), adj=3, axis.args=list(cex.axis=0.7, lwd=0, lwd.tick=0.2, col.tick="gray30", tck=-0.6, col="gray30", col.axis="gray30", line=0, mgp=c(0,0.1,0), at=seq(0,1,0.25), labels=c("0","0.25","0.5","0.75","1")), alpha=1, side=3, horizontal=T)
		...
		plot(legend2, col=cols, legend.only=T, add=T, legend.width=0.5, legend.shrink=0.3, smallplot=c(0.10,0.80,0.03,0.06), adj=3, axis.args=list(cex.axis=0.7, lwd=0, lwd.tick=0.2, col.tick="gray30", tck=-0.6, col="gray30", col.axis="gray30", line=0, mgp=c(0,0.1,0), at=seq(-0.25,0.25,0.25), labels=c("-0.25","0","0.25")), alpha=1, side=3, horizontal=T)
